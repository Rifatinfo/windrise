...
const LOGIN_HERO_IMAGE = '/assets/login-image.png'

/**
 * Same split-screen shell as the sign-in page, so the code step reads as a
 * continuation of it rather than a different site.
 */
export function OtpLayout() {
  return (
